...
export const GeneratorsStatusCardList = () => {
  return (
    <div className="relative flex h-[288px] w-[446px] flex-col gap-3 p-4">
      <CardListBg />
      <h1 className="text-center font-russo text-xl uppercase text-shadow-custom-black">
        Generators
      </h1>
...
function StatusCard() {
  return (
    <div className="flex h-full flex-col items-center justify-items-stretch">
      <StatusPushButtonComponent active />
      <GeneratorsNumberTitleCard title="2" />
      <ValueBoxComponent value={1200} unit="kW" />
    </div>
  );
}
