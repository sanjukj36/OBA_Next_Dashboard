        ...
        >
          <div className="relative flex flex-wrap gap-1">
            {selected.map(option => {
              return (
                ...
                <Badge
                  key={option.value}
                  variant="outline"
                  className="mb-2 mr-1 rounded-[12px] px-[6px] py-[6px] text-xxs font-normal tracking-widest xl:text-xs 2xl:text-base"
                  data-fixed={option.fixed}
                  data-disabled={disabled || undefined}
                >
                  {option.label}
                  ...
                  >
                    <X className="me-0 h-[16px] w-[16px] hover:text-foreground" />
                  </button>
                </Badge>
              );
            })}
            ...
            <button
              ...
              className={cn(
                "absolute right-[-19px] h-6 w-6 p-0",
                (hideClearAllButton ||
                  disabled ||
                  selected.length < 1 ||
